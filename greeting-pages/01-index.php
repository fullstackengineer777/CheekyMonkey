...
<head>
	<meta charset="utf-8">
	<title>Cheeky Monkey Marketing</title>
	...
	<link rel="stylesheet" href="../greeting-assets/css/style.css">
</head>
		...
		<div class="container">
			<div class="start-wrapper">
				...
				<div class="start-action">
			        ...
			        <a onclick="saveStart('./02_specialty.html', 'sales')" class="cta cta-send w-full max-w-sm" data-test-id="continue/start" data-content="sales">
			          <span>Increase&nbsp;business<br>sales</span>
			        </a>
			        <a onclick="saveStart('./02_specialty.html', 'profits')" class="cta cta-send w-full max-w-sm" data-test-id="continue/start" data-content="profits">
